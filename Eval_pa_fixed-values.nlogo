...
@#$#@#$#@
<experiments>
  <experiment name="pa-fixed-0" repetitions="100" runMetricsEveryStep="false">
    <go>eval</go>
    <metric>dist</metric>
    ...
    <enumeratedValueSet variable="powerValue">
      <value value="0"/>
    </enumeratedValueSet>
  ...
  <experiment name="pa-fixed-1" repetitions="100" runMetricsEveryStep="false">
    <go>eval</go>
    <metric>dist</metric>
    <metric>newThreadProb</metric>
    <metric>powerValue</metric>
