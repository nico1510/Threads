...
to setup
  ...
  let noOfForums (threads:read-forums "./ThreadsNeu/threadlegths_sap2.csv" "./ThreadsNeu/randomNumbersFullSAP.csv")
...
to start-annealing
          ...
          ifelse (deltaC <= 0)
           [set accept true  ;we have got a better solution
            if (distanceJ < minDiff)[
              threads:copy-file (word "./ThreadsNeu/results/output_" forumid "(" behaviorspace-run-number ").csv") (word "./ThreadsNeu/results/output_best_" forumid "(" behaviorspace-run-number ").csv")
  ...
  file-delete (word "./results/output_" forumid "(" behaviorspace-run-number ").csv") ; delete last output because it's not needed anymore
  stop
end
...
to create-annealing-file [forumidParam]
  if file-exists? (word "./results/annealing_output_" forumidParam "(" behaviorspace-run-number ").csv")
      [file-delete (word "./results/annealing_output_" forumidParam "(" behaviorspace-run-number ").csv")]
  file-open (word "./results/annealing_output_" forumidParam "(" behaviorspace-run-number ").csv")
...
to-report get-distance [forumidParam startPercentParam endPercentParam contentitems]
  ...
  let currentDistance threads:distance forumidParam startPercentParam endPercentParam (word "./ThreadsNeu/results/output_" forumidParam "(" behaviorspace-run-number ").csv")
...
to debug-forum145
  ...
  if file-exists? "./results/forum145_debug.csv"
      [file-delete "./results/forum145_debug.csv"]
  ...
  [ 
    ifelse (javadistributions:generic-sample2 newThreadProbParam (1 - newThreadProbParam)) = 0
      [threads:new-thread
      file-open "./results/forum145_debug.csv"
  ...
  let currentDistance threads:distance 145 startPercentParam endPercentParam (word "./ThreadsNeu/results/output_" 145 "(" behaviorspace-run-number ").csv")
