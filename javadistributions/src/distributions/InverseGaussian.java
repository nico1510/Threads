...
/**
 * @author Felix We could also think about using the Apache Commons Math
 * package: http://commons.apache.org/math/
 *
 */
public class InverseGaussian {
     ...
     * @param lambda
     * @param mu
     * @return Random number Generates a random number according to an
     * inverse-Gaussian distribution
     */
    public static double getSample(double mu, double lambda, Random rand) {
